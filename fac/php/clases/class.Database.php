...
class Database{
	...
	private $_user = "pbello_wrdp28";
	private $_pass = "HD6iTdKezWVj4";
	private $_db   = "pbello_wrdp28";
...
//   Funcion que pagina cualquier TABLA
// ================================================
Public static function get_todo_usuarios( $tabla, $tabla2, $user ){

	$sql = "SELECT * FROM $tabla,$tabla2 WHERE $tabla.id_rol = $tabla2.id_rol AND $tabla.codigo = '$user' ";
	$resultado = Database::get_row($sql);
	return  $resultado;
